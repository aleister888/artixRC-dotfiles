...
# Misc
packages+=" syncthing fluidsynth extra/github-cli redshift pamixer playerctl lf imagemagick ueberzug inkscape go yad downgrade pv wine wine-mono wine-gecko winetricks xautolock libqalculate remmina gtk-vnc libvncserver xdg-xmenu-git"
# WM
...
installffaddons(){
	addonlist="ublock-origin istilldontcareaboutcookies violentmonkey checkmarks-web-ext darkreader xbs video-downloadhelper clearurls decentraleyes"
	addontmp="$(mktemp -d)"
