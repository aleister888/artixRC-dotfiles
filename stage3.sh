...
# Fuentes
packages+=" ttf-nerd-fonts-symbols-mono ttc-iosevka-ss05 ttf-dejavu ttf-liberation ttf-linux-libertine ttf-opensans ttf-roboto noto-fonts-emoji gnu-free-fonts noto-fonts-cjk"
