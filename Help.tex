...
\vspace{0pt}
\includegraphics[width=\textwidth]{img/vmm_iso_selection.png}
\end{minipage}
\begin{minipage}[t]{\linewidth}%
\vspace{0pt}
\includegraphics[width=\textwidth]{img/vmm_disk_creation.png}
\end{minipage}
\end{multicols}
...
\begin{minipage}[t]{\linewidth}%
\vspace{0pt}
\includegraphics[width=\textwidth]{img/vmm_memory_setup.png}
\end{minipage}
\begin{minipage}[t]{\linewidth}%
\vspace{0pt}
\includegraphics[width=\textwidth]{img/vmm_name.png}
\end{minipage}
\end{multicols}
...
\vspace{0pt}
\centering
\includegraphics[width=\textwidth]{img/Screenshot_win10-7.png}
\end{minipage}
\begin{minipage}[t]{\linewidth}%
\vspace{0pt}
\centering
\includegraphics[width=\textwidth]{img/Screenshot_win10-9.png}
\end{minipage}
\end{multicols}
...
\vspace{0pt}
\centering
\includegraphics[width=\textwidth]{img/Screenshot_win10-91.png}
\end{minipage}
\begin{minipage}[t]{\linewidth}%
\vspace{0pt}
\centering
\includegraphics[width=\textwidth]{img/Screenshot_win10-92.png}
\end{minipage}
\end{multicols}
