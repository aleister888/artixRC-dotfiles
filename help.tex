...
El script te avisa de que el sistema se va suspender y a los 10 minutos lo suspende. Así que tienes que ejecutarlo 10 minutos antes de la hora a la que quieres que el ordenador se suspenda. Para suspender tu equipo automáticamente todos los dias a las 11:00 puedes añadir a tu crontab:
...
\item Las Wikis de Gentoo y Alpine nos resultan útiles, pues ambas distribuciones funcionan con OpenRC. De hecho, si no encuentras un script de OpenRC para algun servicio en los repositorios de Artix, puedes copiar el script que utilizan Alpine o Gentoo.
