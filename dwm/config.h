...
static const Key keys[] = {
	...
	// Cambiar volumen
	{ 0,         XF86XK_AudioLowerVolume,      spawn,            SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -10%; pkill -44 dwmblocks") },
	{ 0,         XF86XK_AudioRaiseVolume,      spawn,            SHCMD("volinc; pkill -44 dwmblocks") },
	...
	{ MODKEY,                       XK_m,      spawn,            SHCMD("volinc; pkill -44 dwmblocks") },
