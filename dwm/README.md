...
- __Modificaciones a la barra de tareas:__
	...
	- La barra de estado tiene colores y una bandeja del sistema: [dwm-status2d-systray-6.4.diff](https://dwm.suckless.org/patches/status2d/dwm-status2d-systray-6.4.diff)
