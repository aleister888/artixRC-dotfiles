...
% Colores
\usepackage{xcolor}
\definecolor{myblue}{RGB}{45,174,211}
...
\tcbuselibrary{skins}
\newtcolorbox{mybox}[1]{colback=myblue!5!white,colframe=myblue!75!black,fonttitle=\bfseries,title=#1}

% Enlaces clicables
\usepackage[colorlinks=true, linkcolor=myblue, urlcolor=myblue]{hyperref}

\title{\textcolor{myblue}{\bfseries Configuración de Artix OpenRC}} % Título del documento
